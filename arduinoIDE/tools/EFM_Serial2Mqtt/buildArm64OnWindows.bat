...
bash -c "ssh odroid@192.168.1.15 'cd %SCRIPT_FOLDER%; /usr/bin/cxfreeze ./%SCRIPT_FILENAME%  --target-dir=linuxArm64'"

mkdir linuxArm64

copy /Y %ODROID_SHARE%\EFM_Serial2Mqtt\linuxArm64\* linuxArm64\
